...
try:
    ...
    params =  '{"InstanceIds":["ins-gwggvy39"],"InstanceChargePrepaid.":1,"InstanceChargePrepaid.RenewFlag":"NOTIFY_AND_MANUAL_RENEW"}'
    # params = '{"InstanceId":"ins-gwggvy39","DataDisks.0.DiskSize":[100]}'
    req.from_json_string(params)

    # 通过client对象调用DescribeInstances方法发起请求。注意请求方法名与请求对象是对应的。
    # 返回的resp是一个DescribeInstancesResponse类的实例，与请求对象对应。
    resp = client.RenewInstances(req)
