...
try:
    ...
    params =  '{"InstanceId":"ins-gwggvy39","ImageId":"img-8toqc6s3","SystemDisk.DiskSize":60,"LoginSettings.Password":"Qcloud@TestApi123++","EnhancedService.SecurityService.Enabled":"TRUE","EnhancedService.MonitorService.Enabled":"TRUE"}'
